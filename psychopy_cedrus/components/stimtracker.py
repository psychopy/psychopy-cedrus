...
class StimTrackerLightSensorBackend(DeviceBackend):
    ...
    backendLabel = _translate("Cedrus StimTracker Light Sensor")
...
class StimTrackerSoundSensorBackend(DeviceBackend):
    ...
    key = "stimtracker"
    # what label should be displayed by Builder for this backend?
    backendLabel = _translate("Cedrus StimTracker Sound Sensor")
    # what hardware classes are relevant to this backend?
...
class StimTrackerButtonBoxBackend(DeviceBackend):
    ...
    """
    key = "stimtracker"
    backendLabel = _translate("Cedrus StimTracker Button Box")
...
StimTrackerVisualValidatorBackend = StimTrackerLightSensorBackend
StimTrackerAudioValidatorBackend = StimTrackerSoundSensorBackend