...
if Version(ppyVersion) >= Version("2025.1.0"):
    ...
    class StimTrackerVoiceKeyBackend(DeviceBackend):
        """
        ...
        deviceClasses = ['psychopy_cedrus.stimtracker.StimTrackerVoiceKeyGroup']
        ...
        def getParams(self: VoiceKeyComponent):
            ...
            order = [
                "stimtrackerIndex",
                "stimtrackerChannels",
                "stimtrackerThreshold",
            ]
            # define params
            params = {}       
            params['stimtrackerIndex'] = Param(
            ...
            params['stimtrackerChannels'] = Param(
            ...
            params['stimtrackerThreshold'] = Param(
        ...
        def writeDeviceCode(self: VoiceKeyComponent, buff):
            ...
            code = (
                ...
                "    deviceClass='psychopy_cedrus.stimtracker.StimTrackerVoiceKeyGroup',\n"
                "    deviceName=%(deviceLabel)s,\n"
                "    pad=%(stimtrackerIndex)s,\n"
                "    channels=%(stimtrackerChannels)s\n"
                "    threshold=%(stimtrackerThreshold)s,\n"
                ")\n"
            )
            buff.writeIndentedLines(code % inits)

    from psychopy.experiment.routines.voicekeyValidator import AudioValidatorRoutine

    class StimTrackerVoiceKeyValidatorBackend(StimTrackerVoiceKeyBackend):
